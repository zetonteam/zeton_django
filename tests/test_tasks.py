...
class TestTaskPost(EndpointTestCase):
    ...
    def test_Success(self):
        ...
        response = self.post(self.VALID_URL, data=self.DATA_JSON_POST)
    ...
    def test_Forbidden(self):
        response = self.post(self.NOT_PERMITTED_URL, data=self.DATA_JSON_POST)
        self.assert_forbidden(response)

    def test_StudentNotFound(self):
        response = self.post(self.STUDENT_NOT_FOUND_URL, data=self.DATA_JSON_POST)
        self.assert_not_found(response)
